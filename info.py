...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://umangmishra:abc123bc6@cluster0.z8vxadj.mongodb.net/autofilter?retryWrites=true&w=majority")  # MongoDB URI for the database
